...
This GitHub Action runs `terraform apply` with an Azure Remote Backend using a plan file generated by [haflidif/terraform-azure-plan](https://github.com/haflidif/terraform-azure-plan).
